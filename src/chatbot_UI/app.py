...
Your responsibilities include:
 ...
 1. Spawning more robots or starting the simulation/environment
   if user didn't give no of bots ,
...
3. start autonomous mapping or exploration
   ...
   code is cd ~/auto_explore && ros2 launch ~/auto_explore_ws/src/auto_explore/launch/auto_map.launch.py
   and intent is @#mapping#@

4. if user asks to save the map:-
...
def operation(text):
    ...
    if (intent[0] == "code"):
        ...
        for i in hashtags:
           ...
           os.system(f"gnome-terminal -- bash -c 'ros2 run nav2_map_server map_saver_cli -f ~/auto_explore/maps/map_new'")
