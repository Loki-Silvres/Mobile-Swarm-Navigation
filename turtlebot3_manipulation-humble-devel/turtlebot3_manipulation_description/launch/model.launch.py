...
def generate_launch_description():
    ...
    # xacro_file = os.path.join(get_package_share_directory('turtlebot3_manipulation_description'), 'urdf', 'turtlebot3_manipulation.urdf.xacro')
    # doc = xacro.process_file(xacro_file, mappings={"prefix":''})
    # urdf_file = doc.toprettyxml()
