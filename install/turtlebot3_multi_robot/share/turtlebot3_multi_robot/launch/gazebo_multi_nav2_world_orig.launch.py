...
def generate_launch_description():
    ...
    #     ]
    robots=[]
    yaml_file = os.path.join(get_package_share_directory('turtlebot3_multi_robot'),'params','robot_data.yaml')
    ...
    map_server=Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('turtlebot3_gazebo'), 'launch', 'my_map.yaml'),
                     },],
